...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 1803ce59-eb47-4ad9-9dc1-87b815dc5922
```

> `1803ce59-eb47-4ad9-9dc1-87b815dc5922` is the password of the certificate, you can change it to any password you want.
